    ...
    <main class="site-main">
        ...
        <section id="gallery-page" class="py-5">
            ...
            <div class="container">
                ...
                <div class="co-12 text-center my-3" data-aos="fade-right"><h2>Classic Lash Extensions</h2></div>  
                ...
                <div class="co-12 text-center my-3" data-aos="fade-right"><h2>Hybrid Lash Extensions</h2></div> 
                ...
                <div class="co-12 text-center my-3" data-aos="fade-right"><h2>Volume Lash Extensions</h2></div> 
                ...
                <div class="co-12 text-center my-3" data-aos="fade-right"><h2>Lash Lift & Ttint</h2></div> 
                ...
                <div class="co-12 text-center my-3" data-aos="fade-right"><h2>Powder Brows</h2></div> 
                ...
                <div class="co-12 text-center my-3" data-aos="fade-right"><h2>Combo Brows</h2></div> 
                ...
                <div class="co-12 text-center my-3" data-aos="fade-right"><h2>Lip Blush</h2></div> 
