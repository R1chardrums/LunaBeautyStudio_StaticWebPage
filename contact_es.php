...
<head>
    ...
    <title>Luna Beauty Studio - Contáctanos</title>
</head>
	...
	<main class="site-main">
    	<section id="presentation-page" class="p-5">
    	  ...
    	  <div class="row align-items-center justify-content-center">
    	    <h1 class="text-center" style="color:#fff; font-size: 45px!important;">Contáctanos</h1>
    	  </div>
    	</section>
						...
						<form>
						  <div class="row">
						  	<div class="col-12 text-center">
						  		<h2 style="color:#6d6e70!important; font-size: 30px!important;">Envíanos un Mensaje</h2>
						  	</div>
						    ...
						    <div class="form-group col-md-6 my-2">
						      <label for="mail"><p>Correo Electrónico</p></label>
						  ...
						  <div class="row">
							<div class="form-group col-md-6 my-2">
							  ...
							  <input type="number" class="form-control" id="phone">
				                ...
				                <div class="form-group col-md-6 my-2">
				                	<label for="service"><p>Servicios</p></label>
				                    <select class="form-control" id="service">
				                    	<option value="">Seleccionar</option>
				                    	<option value="Classic Lash Extensions">Extensiones de Pestañas Clásicas</option>
				                    	<option value="Hybrid Lash Extensions">Extensiones de Pestañas Híbridas</option>
				                    	<option value="Volume Lash Extensions">Extensiones de Pestañas de Volumen</option>
				                    	<option value="Lash Lift & Tint">Levantamiento de Pestañas y Tinte</option>
				                    	<option value="Microblading">Microblading</option>
				                    	<option value="Powder Brows">Cejas con Polvo</option>
				                    	<option value="Combo Brows">Cejas Combinadas</option>
				                    	<option value="Lip Blush">Maquillaje de Labios</option>
				                    </select>
				                </div>
						  </div>
						    <div class="form-group my-2">
						      <label for="message"><p>Mensaje</p></label>
						      <textarea class="form-control" id="message"></textarea>
						    </div>
						    <div class="col-12 text-center mt-4">
						  		<button type="submit" class="btn-reviews">Enviar Mensaje</button>
							</div>
						</form>
